...
var constants_1 = require("@tronproject/constants");
...
var tron_formatter_1 = require("./tron-formatter");
//////////////////////////////
// Event Serializeing
...
var BaseProvider = /** @class */ (function (_super) {
    ...
    BaseProvider.getFormatter = function () {
        if (defaultFormatter == null) {
            defaultFormatter = new tron_formatter_1.Formatter();
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!!bignumber_1.BigNumber.from(network.chainId).eq(currentNetwork.chainId)) return [3 /*break*/, 5];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, web_1.poll(function () { return __awaiter(_this, void 0, void 0, function () {
                                var result, tx, blockNumber, confirmations, receipt;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 4:
                                            ...
                                            if (!(tx.creates == null && tx.to == null)) return [3 /*break*/, 6];
                                        ...
                                        case 5:
                                            ...
                                            _a.label = 6;
                                        case 6: return [2 /*return*/, this._wrapTransaction(tx)];
                                    }
                                });
                            }); }, { oncePoll: this })];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, tron_formatter_1.Formatter.arrayOf(this.formatter.filterLog.bind(this.formatter))(logs)];
                }
            });
        });
    };
