...
exports.BaseJsonRpcProvider = void 0;
...
var BaseJsonRpcProvider = /** @class */ (function (_super) {
    __extends(BaseJsonRpcProvider, _super);
    function BaseJsonRpcProvider(url, network) {
        var _newTarget = this.constructor;
        var _this = this;
        logger.checkNew(_newTarget, BaseJsonRpcProvider);
    ...
    Object.defineProperty(BaseJsonRpcProvider.prototype, "_cache", {
        get: function () {
    ...
    BaseJsonRpcProvider.defaultUrl = function () {
        return "http:/\/localhost:8545";
    };
    BaseJsonRpcProvider.prototype.detectNetwork = function () {
        var _this = this;
    ...
    BaseJsonRpcProvider.prototype._uncachedDetectNetwork = function () {
                    ...
                    case 9:
                        if (chainId != null) {
                            ...
                            try {
                                ...
                                return [2 /*return*/, getNetwork(chainId)];
                            }
                            catch (error) {
    ...
    BaseJsonRpcProvider.prototype.listAccounts = function () {
        var _this = this;
        return this.send("eth_accounts", []).then(function (accounts) {
            return accounts.map(function (a) { return _this.formatter.address(a); });
        });
    };
    BaseJsonRpcProvider.prototype.send = function (method, params) {
        var _this = this;
        var request = {
            method: method,
            params: params,
    ...
    BaseJsonRpcProvider.prototype.prepareRequest = function (method, params) {
        switch (method) {
            case "getBlockNumber":
    ...
    BaseJsonRpcProvider.prototype.perform = function (method, params) {
        return __awaiter(this, void 0, void 0, function () {
            var args, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BaseJsonRpcProvider.prototype._startEvent = function (event) {
        if (event.tag === "pending") {
            this._startPending();
        }
        _super.prototype._startEvent.call(this, event);
    };
    BaseJsonRpcProvider.prototype._startPending = function () {
    ...
    BaseJsonRpcProvider.prototype._stopEvent = function (event) {
    ...
    BaseJsonRpcProvider.hexlifyTransaction = function (transaction, allowExtra) {
    ...
    return BaseJsonRpcProvider;
}(base_provider_1.BaseProvider));
exports.BaseJsonRpcProvider = BaseJsonRpcProvider;
