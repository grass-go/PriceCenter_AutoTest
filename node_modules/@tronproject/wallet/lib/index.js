...
exports.Wallet = exports.verifyTypedData = exports.verifyMessage = exports.BaseWallet = void 0;
var address_1 = require("@tronproject/address");
var abstract_provider_1 = require("@tronproject/abstract-provider");
var abstract_signer_1 = require("@tronproject/abstract-signer");
var bytes_1 = require("@tronproject/bytes");
var hash_1 = require("@tronproject/hash");
var hdnode_1 = require("@tronproject/hdnode");
var keccak256_1 = require("@tronproject/keccak256");
var properties_1 = require("@tronproject/properties");
var random_1 = require("@tronproject/random");
var signing_key_1 = require("@tronproject/signing-key");
var json_wallets_1 = require("@tronproject/json-wallets");
var transactions_1 = require("@tronproject/transactions");
...
var BaseWallet = /** @class */ (function (_super) {
    __extends(BaseWallet, _super);
    function BaseWallet(privateKey, provider, addressType) {
        ...
        if (isAccount(privateKey)) {
            ...
            properties_1.defineReadOnly(_this, "address", transactions_1.computeAddress(_this.publicKey, addressType));
    ...
    Object.defineProperty(BaseWallet.prototype, "mnemonic", {
        get: function () { return this._mnemonic(); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(BaseWallet.prototype, "privateKey", {
        get: function () { return this._signingKey().privateKey; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(BaseWallet.prototype, "publicKey", {
        get: function () { return this._signingKey().publicKey; },
        enumerable: false,
        configurable: true
    });
    BaseWallet.prototype.getAddress = function () {
        return Promise.resolve(this.address);
    };
    BaseWallet.prototype.connect = function (provider) {
        return new Wallet(this, provider);
    };
    BaseWallet.prototype.signTransaction = function (transaction) {
        var _this = this;
    ...
    BaseWallet.prototype.signMessage = function (message) {
    ...
    BaseWallet.prototype._signTypedData = function (domain, types, value) {
        return __awaiter(this, void 0, void 0, function () {
            var populated;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    BaseWallet.prototype.encrypt = function (password, options, progressCallback) {
     ...
     */
    BaseWallet.createRandom = function (options) {
    ...
    BaseWallet.fromEncryptedJson = function (json, password, progressCallback) {
        return json_wallets_1.decryptJsonWallet(json, password, progressCallback).then(function (account) {
            return new Wallet(account);
        });
    };
    BaseWallet.fromEncryptedJsonSync = function (json, password) {
        return new Wallet(json_wallets_1.decryptJsonWalletSync(json, password));
    };
    BaseWallet.fromMnemonic = function (mnemonic, path, wordlist) {
        if (!path) {
...
var Wallet = /** @class */ (function (_super) {
    ...
    Wallet.prototype.signTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            var txID, signature, r, s, id, signHex;
            return __generator(this, function (_a) {
                txID = "0x" + transaction.txID;
                signature = this._signingKey().signTronDigest(txID);
                r = signature.r.replace(/^(0x)/, '');
                s = signature.s.replace(/^(0x)/, '');
                id = signature.recoveryParam.replace(/^(0x)/, '');
                signHex = r + s + id;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.from = _b.sent();
                        return [2 /*return*/, this.provider.buildTronTransaction(transaction).then(function (res) {
                                if (res.error) {
                                    throw new Error(JSON.stringify(res.error));
                                }
                                return _this.signTransaction(res.result.transaction).then(function (signedTx) {
                                    return _this.provider.sendTronTransaction(signedTx);
                                });
                            })];
                }
            });
