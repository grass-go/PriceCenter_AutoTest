...
var abi_1 = require("@tronproject/abi");
...
function getSendTransaction(contract, fragment, args) {
    return __awaiter(this, void 0, void 0, function () {
        var tx, allowedTriggerTransactionKeys, key, data, txValue, txTokenValue, txTokenId;
        return __generator(this, function (_a) {
            tx = {};
            allowedTriggerTransactionKeys = {
                from: true,
                to: true,
                data: true,
                gas: true,
            ...
            if (tx.value || tx.tokenValue) {
                txValue = bignumber_1.BigNumber.from(tx.value || 0);
                txTokenValue = bignumber_1.BigNumber.from(tx.tokenValue || 0);
                txTokenId = bignumber_1.BigNumber.from(tx.tokenId || 0);
                if (fragment.payable) {
                    if (!txTokenValue.isZero() && txTokenId.isZero()) {
                        logger.throwError("payable method miss tokenId", logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
                    ...
                    if (!txTokenValue.isZero()) {
                        logger.throwError("non-payable method cannot override token value", logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, getSendTransaction(contract, fragment, args)];
                    case 3:
                        txRequest = _a.sent();
...
var ContractFactory = /** @class */ (function () {
    function ContractFactory(contractInterface, bytecode, signer) {
        ...
        properties_1.defineReadOnly(this, "interface", properties_1.getStatic((_newTarget), "getInterface")(contractInterface));
        properties_1.defineReadOnly(this, "abiCode", JSON.stringify(contractInterface));
    ...
    ContractFactory.prototype.getDeployTransaction = function () {
        ...
        // Populate "value" override
        if (tx.value || tx.tokenValue) {
            var txValue = bignumber_1.BigNumber.from(tx.value || 0);
            var txTokenValue = bignumber_1.BigNumber.from(tx.tokenValue || 0);
            var txTokenId = bignumber_1.BigNumber.from(tx.tokenId || 0);
            if (this.interface.deploy.payable) {
                if (!txTokenValue.isZero() && txTokenId.isZero()) {
                    logger.throwError("payable constructor miss tokenId", logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "overrides.tokenId",
                        value: tx.tokenId
                    });
                }
                ...
                if (!txTokenValue.isZero()) {
                    logger.throwError("non-payable constructor cannot override token value", logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "overrides.tokenValue",
                        value: tx.tokenValue
                    });
                }
    ...
    ContractFactory.prototype.deploy = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var overrides, params, unsignedTx, tx, txInfo, address, contract;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        overrides = {};
                    ...
                    case 3:
                        txInfo = _a.sent();
                        address = txInfo.contractAddress;
