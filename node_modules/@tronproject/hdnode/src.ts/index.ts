...
import { arrayify, BytesLike, concat, hexDataSlice, hexZeroPad, hexlify } from "@tronproject/bytes";
import { BigNumber } from "@tronproject/bignumber";
import { toUtf8Bytes, UnicodeNormalizationForm } from "@tronproject/strings";
import { pbkdf2 } from "@tronproject/pbkdf2";
import { defineReadOnly } from "@tronproject/properties";
import { SigningKey } from "@tronproject/signing-key";
import { computeHmac, ripemd160, sha256, SupportedAlgorithm } from "@tronproject/sha2";
import { computeAddress } from "@tronproject/transactions";
import { Wordlist, wordlists } from "@tronproject/wordlists";
...
export const defaultPath = "m/44'/195'/0'/0/0";
