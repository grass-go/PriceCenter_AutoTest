...
For signing, see the [Abstract Signer](https://www.npmjs.com/package/@tronproject/abstract-signer)
or [Wallet](https://www.npmjs.com/package/@tronproject/wallet) sub-modules.
...
} = require("@tronproject/abstract-provider");
```
