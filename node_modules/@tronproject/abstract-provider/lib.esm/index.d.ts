...
export declare type TronSendTransaction = {
    from?: string;
    to: string;
    value: BigNumberish;
    tokenId?: number;
...
export declare type TronTransactionRequest = {
...
export declare type TronTransactionReceipt = {
    contract_address?: string;
    raw_data?: any;
    raw_data_hex?: string;
    ret?: Array<any>;
...
export declare type TronTransactionResponse = {
    result?: string;
    code?: string;
    message?: string;
