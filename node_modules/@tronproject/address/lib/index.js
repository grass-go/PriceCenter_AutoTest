...
exports.getCreate2Address = exports.getContractAddress = exports.getIcapAddress = exports.isAddress = exports.formatAddress = exports.getAddress = void 0;
...
var rlp_1 = require("@tronproject/rlp");
var logger_1 = require("@tronproject/logger");
var _version_1 = require("./_version");
var tronAddress_1 = require("./tronAddress");
...
function getAddress(address, addressType) {
    ...
    else if (address.match(/^T[0-9A-Za-z]{33}$/) && tronAddress_1.isAddressValid(address)) {
        result = tronAddress_1.toHexAddress(address);
    }
    else {
        logger.throwArgumentError("invalid address", "address", address);
    }
    ...
    switch (addressType) {
        case 1:
            if (address.match(/^(0x)?[0-9a-fA-F]{40}$/)) {
                ...
                return tronAddress_1.toHexAddress(address).replace(/^(0x)?41/, "0x");
            }
        case 2:
            if (address.match(/^(0x)?[0-9a-fA-F]{40}$/)) {
                ...
                return tronAddress_1.toHexAddress(address).replace(/^(0x)?41/, "0x41");
            }
        case 3: {
            if (address.match(/^T[0-9A-Za-z]{33}$/)) {
                ...
                return tronAddress_1.toTronAddress(address);
            }
        }
        default:
            return address;
