...
function computeAddress(key, addressType) {
    ...
    return address_1.getAddress(bytes_1.hexDataSlice(keccak256_1.keccak256(bytes_1.hexDataSlice(publicKey, 1)), 12), addressType);
}
...
function _serialize(transaction, signature) {
    ...
    if (chainId !== 0) {
        ...
        raw.pop();
        raw.pop();
        v += bignumber_1.BigNumber.from(chainId).mul(2).add(8).toNumber();
