...
var Signer = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        if (tx.chainId == null) {
                            ...
                            tx.chainId = Promise.all([
                                ...
                                if (!bignumber_1.BigNumber.from(results[1]).isZero() && !bignumber_1.BigNumber.from(results[0]).eq(results[1])) {
    ...
    Signer.prototype._checkTronProvider = function (operation) {
        if (!this.provider._isTron) {
            logger.throwError("missing tron provider", logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
