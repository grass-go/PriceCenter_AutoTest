...
@Slf4j
public class CheckDiffAccessWayCMCTokens {
    ...
    public void CheckSameValueGotByDiffFormat(String curSymbol,String curAddress, String curTolerance ) throws URISyntaxException {
        ...
        Object trxAddressPrice = JSONPath.eval(responseContent, String.join("", "$..quote.T9yD14Nj9j7xAB4dbGeiX9h8unkKHxuWwb.price[0]"));
        Object usdtAddressPrice = JSONPath.eval(responseContent, String.join("", "$..quote.TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t.price[0]"));
        Object usdAddressPrice = JSONPath.eval(responseContent, String.join("", "$..quote.USD.price[0]"));
    ...
    public Object[][] data() throws IOException {
        ...
        Object[][] data = new Object[totalLine][columnNum];
        for(int i = 0; i<totalLine; i++){
            String stringValue[] = contentLines.get(i).split(",");
            for(int j = 0; j<columnNum; j++) {
                data[i][j] = stringValue[j];
            }
        }
