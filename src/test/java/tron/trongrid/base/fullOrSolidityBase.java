...
public class fullOrSolidityBase {
  ...
  public static HttpResponse createConnectWithKey(String url, JsonObject requestBody) {
    try {
      ...
      httppost.setHeader("Content-type", "application/json; charset=utf-8");
      httppost.setHeader("Connection", "Close");
      httppost.addHeader("TRON-PRO-API-KEY", "6a5b17eb-9935-424a-92fe-c682e24c2e7e");
      httppost.addHeader("User-Agent","a8iiu");
      httppost.addHeader("Origin","https://6ty.1trog.io");
      httppost.addHeader("Authorization","Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImY2N2MzM" +
