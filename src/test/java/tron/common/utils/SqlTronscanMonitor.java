...
public class SqlTronscanMonitor implements IReporter{
...
//            output.close();
    ...
    public void mysql(){
        ...
        try{
            ...
            String sql = "INSERT INTO `AutoTestScan`.`tronscanMonitor`(`time`, `status`, `sucessclass`, `sucessnum`,`failClass`,`failnum`,`sum`,`buildid`) VALUES ('"+time+"','"+status+"','"+sucessClass+"','"+sucessnum+"','"+failClass+"','"+failnum+"','"+sum+"','"+buildid+"')";
