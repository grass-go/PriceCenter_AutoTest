...
public class SqlTronscanAPI implements IReporter{
...
//            output.close();
    ...
    public void mysql(){
        ...
        try{
            ...
            String sql = "INSERT INTO `AutoTestScan`.`tronscanAPI`(`time`, `status`, `sucessClass`, `failClass`) VALUES ('"+time+"','"+status+"','"+sucessClass+"','"+failClass+"')";
