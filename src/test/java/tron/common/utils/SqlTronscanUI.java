...
//            output.close();
    ...
    public void mysql(){
        ...
        try{
            ...
            String sql = "INSERT INTO `AutoTestScan`.`tronscanUI`(`time`, `status`, `sucessclass`, `sucessnum`,`failClass`,`failnum`,`sum`) VALUES ('"+time+"','"+status+"','"+sucessClass+"','"+sucessnum+"','"+failClass+"','"+failnum+"','"+sum+"','"+buildid+"')";
