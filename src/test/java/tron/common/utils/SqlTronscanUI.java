...
//            output.close();
    ...
    public void mysql(){
        HttpResponse response = TronscanApiList.getBuildId("http://tronlink:tronlink@172.16.22.178:8080/job/Tronscan_AutoTest/api/json");
        ...
        try{
            ...
            String sql = "INSERT INTO `AutoTestScan`.`tronscanUI`(`time`, `status`, `sucessclass`, `sucessnum`,`failClass`,`failnum`,`sum`,`buildid`) VALUES ('"+time+"','"+status+"','"+sucessClass+"','"+sucessnum+"','"+failClass+"','"+failnum+"','"+sum+"','"+buildid+"')";
