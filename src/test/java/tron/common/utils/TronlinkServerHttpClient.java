...
public class TronlinkServerHttpClient {
  ...
  public static Integer soTimeout =
  ...
  public static HttpResponse createGetConnect(
      String url, Map<String, String> params, JSONObject requestBody, Map<String, String> header) {
    try {
      httpClient
          .getParams()
  ...
  public static HttpResponse createPostConnect(
      String url, Map<String, String> params, String requestBody, Map<String, String> header) {
    try {
      httpClient
          .getParams()
          .setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, connectionTimeout);
  ...
  public static HttpResponse createPostConnect(
      String url, Map<String, String> params, JSONArray requestBody, Map<String, String> header) {
    try {
      httpClient
          .getParams()
          .setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, connectionTimeout);
      ...
      if (requestBody != null) {
        StringEntity entity =
            new StringEntity(requestBody.toJSONString(), Charset.forName("UTF-8"));
        entity.setContentEncoding("UTF-8");
        entity.setContentType("application/json");
        httppost.setEntity(entity);
      }
  ...
  public static HttpResponse createPutConnect(
      String url, Map<String, String> params, JSONObject requestBody, Map<String, String> headers) {
    try {
  ...
  public static HttpResponse createDeleteConnect(
      String url, Map<String, String> params, JSONObject requestBody, Map<String, String> headers) {
  ...
  public static void printHttpInfo(
      HttpPost httppost, Map<String, String> params, JSONObject requestbody) {
  ...
  public static Map<String, String> getNewSigHeader(
      String needSys, String testVersion, String testLang, String testPkg) {
  ...
  public static HttpResponse createGetConnectWithSignature(
      String curURI,
      Map<String, String> caseParams,
      Map<String, String> caseHeader,
      JSONObject object) {
    ...
    if (caseParams != null && caseParams.containsKey("address")) {
      // String curUri,String httpMethod, String address, String needSys, String testVersion, String
      // testLang, String testPkg
    ...
    log.info("123123:" + requestUrl);
    response = createGetConnect(requestUrl, params, object, headers);
    return response;
  }

  public static HttpResponse createPostConnectWithSignature(
      String curURI,
      Map<String, String> caseParams,
      Map<String, String> caseHeader,
      JSONObject object) {
  ...
  public static HttpResponse createPostConnectWithSignature(
    ...
    Map<String, String> headers =
        getNewSigHeader(defaultSys, defaultVersion, defaultLang, defaultPkg);
    if (caseHeader != null) {
      headers = AddMap(headers, caseHeader);
    }
    // String curUri,String httpMethod, String address, String needSys, String testVersion, String
