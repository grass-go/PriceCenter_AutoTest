...
public class HomePageTest extends Base {
  ...
  public void before() throws Exception {
    ...
    Thread.sleep(5000);
    if (!elementIsExist(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/main/div/div[1]/div[2]/div/div/div/div[1]/div[1]/div"))) {
  ...
  public void test001HomeDis() throws Exception {
    ...
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        ...
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/main/div/div[3]/div[1]/div[2]/div[2]/div/div[1]/div[1]"))
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[1]/table/tbody/tr[1]/td[2]/span"))
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(
        By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[1]/table/tbody/tr[2]/td[2]"))
        .isDisplayed());

    // Latest Price
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[2]/div/div[1]/div[1]/span/span[1]/span"))
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[2]/div/div[3]/div[1]/span/span[1]/span"))
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[2]/div/div[2]/div[1]/span/span[1]/span"))
        .isDisplayed());
    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[2]/div/div[4]/div[1]/span/span[1]/span"))
        .isDisplayed());

    // Global CDP info
    Assert.assertEquals(DRIVER
        .findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[4]/div/h3[1]"))
        .getText(), "CDP 全局质押率");
    Assert.assertTrue(DRIVER.findElement(
        By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[4]/div/div[1]/span/span[1]"))
        .isDisplayed());

    Assert.assertTrue(DRIVER.findElement(By.xpath(
        "//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[4]/div/div[2]/span/span[1]/span"))
        .isDisplayed());
    Assert.assertEquals(DRIVER
        .findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div[2]/aside/div/div[4]/div/h3[2]"))
        .getText(), "USDJ 全网总量");
  }
  ...
  public void test002CdpDepositBtn() throws Exception {
    ...
    Assert.assertTrue(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[2]")).isDisplayed());

    // deposit btn is enEnabled
    Assert.assertFalse(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[3]/button[2]")).isEnabled());
  ...
  public void test007MoveCdpBtn() throws Exception {
    ...
    Assert.assertFalse(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[2]/label/span[1]"))
            .isSelected());
    Assert.assertFalse(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[4]/button[2]")).isEnabled());

    // [MOVE] btn is disEnabled , set Receiving address and select confirm choices
    DRIVER.findElement(By.xpath("//*[@id=\"inputValue\"]"))
        .sendKeys("TAYzcfLovWdV83g25Apfd7BA67J44D5z5M");
    Thread.sleep(3000);
    Assert.assertFalse(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[5]/button[2]")).isEnabled());
    Assert.assertTrue(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[3]/label/span[1]/input"))
            .isSelected());
  ...
  public void test008CloseCdpBtn() throws Exception {
    ...
    // select USDJ to pay
    DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[1]/div[6]/div/div/label"))
        .click();
    Thread.sleep(1000);
    Assert.assertTrue(
        DRIVER.findElement(By.xpath("//*[@id=\"dialog\"]/div/form/div[1]/div[6]/div/div/div"))
            .isDisplayed());
  ...
  public void test009Exit() throws Exception {
    // exit
    DRIVER.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div[1]/div[2]/a[2]")).click();
    Thread.sleep(1500);
