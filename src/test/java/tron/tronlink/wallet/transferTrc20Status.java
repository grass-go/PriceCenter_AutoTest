...
public class transferTrc20Status extends TronlinkBase {
    ...
    public void getTrc20_StatusLowVersionWithNoSig() throws Exception {
        ...
        for(index=0; index<5; index++){
            ...
            response = TronlinkApiList.apiTransferTrc20StatusNoSig(param,null);
    ...
    public void getTrc20_StatusHighVersionWithNoSig() throws Exception {
        param.put("address",quince_B58); //sophia's address
        param.put("db_version","1");
        param.put("direction","0");
        param.put("limit","20");
        ...
        response = TronlinkApiList.apiTransferTrc20StatusNoSig(param,header);
        responseContent = TronlinkApiList.parseResponse2JsonObject(response);
