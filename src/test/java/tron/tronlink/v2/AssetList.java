...
public class AssetList extends TronlinkBase {
  ...
  public void assetList01() {
    ...
    InputStreamReader input =
        new InputStreamReader(
            new FileInputStream(new File("src/test/resources/TestData/new1_assetList_v1_exp.json")),
            "UTF-8");
    ...
    String cmp_result =
        new CompareJson("data", "priceCny,priceUSD").compareJson(responseString, expResponse);
  ...
  public void assetList02() {
    ...
    InputStreamReader input =
        new InputStreamReader(
            new FileInputStream(new File("src/test/resources/TestData/new1_assetList_v2_exp.json")),
            "UTF-8");
    int len = input.read(cbuf);
    String expResponse = new String(cbuf, 0, len);
    ...
    String cmp_result =
        new CompareJson("data", "priceCny,priceUSD,price").compareJson(responseString, expResponse);
    System.out.println("=========actual response========== " + responseString + " ");
    System.out.println("=========expect response========== " + expResponse + " ");
    System.out.println("=========cmp_result=============== " + cmp_result);
    Assert.assertEquals("null", cmp_result);
  ...
  @Test(enabled = true)
  public void assetListTestTotalBalanceStr() {
    params.clear();
    params.put("address", quince_B58);
    params.put("version", "v2");
    response = TronlinkApiList.v2AssetList(params);
