...
public class unfollowAssetList extends TronlinkBase {
  ...
  @Test(
      enabled = true,
      description = "有余额有价值的币，取消关注,可以查到",
      groups = {"P2"})
  public void unfollowAssetList01() throws Exception {
    ...
    Map<String, String> params =
        sig.GenerateParams(followAsset, "/api/wallet/v2/unfollowAssetList", "GET");
  ...
  @Test(
      enabled = true,
      description = "验证余额balance=0的普通币，加关注，也不在unfollow接口",
      groups = {"P2"})
  ...
  @Test(
      enabled = true,
      description = "系统推荐币（线上：USDT）没有余额,balance=0， 取消关注，在unfollow接口。",
      groups = {"P2"})
  public void unfollowAssetList04() throws Exception {
    ...
    Object usdtNational =
        JSONPath.eval(responseContent, "$..data.token[name='Tether USD'].national[0]");
  ...
  @Test(
      enabled = true,
      description = "系统推荐币（线上：USDT）没有余额balance=0， 关注，不在unfollow接口。",
      groups = {"P2"})
  ...
  @Test(enabled = true, description = "有余额有价值的币，取消关注,可以查到")
  public void unfollowAssetListTestTotalBalanceStr() throws Exception {
    // 查询
    Map<String, String> params = new HashMap<>();
    Map<String, String> headers = new HashMap<>();
    params.put("address", "TX74o6dWugAgdaMv8M39QP9YL5QRgfj32t");
