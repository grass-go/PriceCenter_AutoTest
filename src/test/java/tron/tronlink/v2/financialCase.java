...
public class financialCase extends TronlinkBase {
    ...
    @BeforeClass(enabled = true,description = "request tokenFinancialList and save response ")
    ...
    @Test(enabled = true, description = "check math relationship")
    ...
    @Test(enabled = true, description = "check token order")
    ...
    @Test(enabled = true, description = "check justlend token apy")
    ...
    @Test(enabled = true, description = "check bttc apy")
    ...
    @Test(enabled = true, description = "check trx vote apy")
    ...
    @Test(enabled = true, description = "check Available Balance In Assets, tokenlist, justlend detail")
    ...
    @Test(enabled = true, description = "check FinancialAssets InJustlend, v2Asset, myFinancialTokenList, myFinancialProjectList, justLendDetail,justLendOperate: financialAssetsValue")
    ...
    @Test(enabled = true, description = "check trx financialAsset in froozen")
    ...
    @Test(enabled = true, description = "check btt financialAsset in bttc project")
    ...
    @Test(enabled = false, description = "check justlend financialIncome in justlend project")
    ...
    @Test(enabled = true, description = "check Trx financialIncome in trx staking project")
    ...
    @Test(enabled = true, description = "check btt financialIncome in bttc project")
    ...
    @Test(enabled = true, description = "check available balance in tokenFinancialList,asset,justLendDetail, justLendOperate")
