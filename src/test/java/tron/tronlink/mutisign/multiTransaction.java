...
//    String signString = TronlinkApiList.getTransactionSignStringFromFullnode(fullnodeHttpServer,multiAddress,foundationAccountAddress,10L,3,foundationAccountKey);
...
//    response = TronlinkApiList.multiTransaction(transaction);
//    TronlinkApiList.printJsonContent(TronlinkApiList.parseJsonObResponseContent(response));
//
//
//
//  }
...
//    String url = "wss://testlist.tronlink.org/TronlinkApiList/wallet/multi/socket?address=" + base58MutiAddress + "&netType=main_net";
...
//      signatureArray.add(TronlinkApiList.getSignature(hash,multiKey));
//      raw.put("signature",signatureArray);
//      raw.put("raw_data",rawDataObject);
//      transaction.put("transaction",raw);
//      System.out.println(transaction);
//      response = TronlinkApiList.multiTransaction(transaction);
//      JSONObject jsonObject = TronlinkApiList.parseJsonObResponseContent(response);
//      TronlinkApiList.printJsonContent(TronlinkApiList.parseJsonObResponseContent(response));
