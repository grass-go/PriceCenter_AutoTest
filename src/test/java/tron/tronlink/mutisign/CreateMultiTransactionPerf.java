...
/**
    ...
    @Test(enabled = true,invocationCount = 1000, description = "send coin 100 times")
    public void sendCoinDirectely() throws InterruptedException {
        channelFull = ManagedChannelBuilder.forTarget(fullnode).usePlaintext(true).build();
        blockingStubFull = WalletGrpc.newBlockingStub(channelFull);

        TronlinkApiList.sendcoinDirectely(quince, 22L, wqq1, wqq1key,
                        blockingStubFull);
        Thread.sleep(1000);
